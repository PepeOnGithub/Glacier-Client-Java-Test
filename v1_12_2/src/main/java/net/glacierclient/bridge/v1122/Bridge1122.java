...
public class Bridge1122 extends AbstractVersionBridge {
    ...
    @Override public boolean isMouseButtonDown(int btn) { return false; }
    ...
    @Override public String  getMinecraftVersion() { return "1.12.2"; }
    @Override public String  getVersionId()        { return "v1_12_2"; }
    @Override
    public boolean hasCapability(BridgeCapability cap) {
        return switch (cap) {
            case OFFHAND, SHIELDS, ELYTRA, BOSSBAR, ATTACK_COOLDOWN, TOTEMS, DUAL_WIELD -> true;
            default -> false;
        };
    }
}
