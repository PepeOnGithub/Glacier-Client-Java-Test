...
public final class RabbitEarsHat extends GlacierMod {
    ...
    public RabbitEarsHat() {
        super("RabbitEars", "Renders tall rabbit ears that wiggle when moving", Category.COSMETICS, -1);
        addSettings(color, animated);
    }
    @EventListen
